...
SUPERLATIVE_INSTRUCTIONS = """최상급 표현: 허위사실로 오인될 수 있는 표현
   - 해당 표현: 최초, 최대, 최고, 유일, 독보적, 가장, 압도적, 세계 최
   - 아래 표현은 검출 대상에서 반드시 제외할 것: 선도, 이해도 100%, 최적, 최적화, 최대 OOO(뒤에 구체적인 수치·단위가 붙는 "최대" 표현, 예: 최대 200명, 최대 30%), 극대화, 최대한, 최우선, 최선, 최신, 최근, 탁월, 탁월한
